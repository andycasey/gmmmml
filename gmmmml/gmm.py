...
class GaussianMixture(object):
    ...
    def _strategy_search_(self, y, strategy_class, **kwargs):
        ...
        strategy = strategy_class(self, **kwds)

        self._results = dict(strategy.initialise(y, **kwds))
    ...
    def _search_bayes_stepper(self, y, expected_improvement_fraction=0.01,
        ...
        for iteration in range(1000):
            ...
            Kp, I, I_var, I_lower = self._predict_message_length(Kp, N, D, **kwds)
            ...
            for K in K_nexts:
                ...
                try:
                    *state, R = self.initialize(y, K_goto, **kwds)
                    ...
                    # Update predictions.
                    Kp, I, I_var, _ = self._predict_message_length(Kp, N, D, **kwds)
    ...
    def _search_bayes_jumper(self, y, expected_improvement_fraction=0.01,
        ...
        for iteration in range(1000):
            ...
            Kmax = 1.1 * np.max(np.hstack(self._results.keys()))
            Kp = np.unique(np.arange(1, 1 + Kmax)).astype(int)
            Kp, I, I_var, I_lower = self._predict_message_length(Kp, N, D, **kwds)
            ...
            for K in K_nexts:
                ...
                try:
                    state, responsibilities, ll, I = operations.repartition_mixture(y, 
                        *previous_state, K, **kwds)
